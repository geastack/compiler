...
verifyProperty(Date.prototype.getTime, 'name', { value: 'getTime', writable: false, enumerable: false, configurable: true })
console.log('getTime name ok')
